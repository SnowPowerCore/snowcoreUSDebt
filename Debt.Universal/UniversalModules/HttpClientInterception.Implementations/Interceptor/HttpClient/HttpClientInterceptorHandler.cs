using Debt.HttpClientInterception.Interceptor.HttpClient;
using System.Net;
using System.Reflection;

namespace Debt.HttpClientInterception.Implementations.Interceptor.HttpClient;
...
internal class HttpClientInterceptorHandler : HttpMessageHandler
{
    ...
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                response = await (SendAsyncMethod.Invoke(_baseHandler, [request, cancellationToken]) as Task<HttpResponseMessage>);
            }
            return response;
        }
        catch (Exception e)
